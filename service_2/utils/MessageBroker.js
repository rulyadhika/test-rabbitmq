...
const CURRENT_SERVICE = "SERVICE 2";
const CURRENT_SERVICE_SINGLE_BINDING_KEY = "SERVICE_2_BINDING_KEY"
const CURRENT_SERVICE_SINGLE_QUEUE = "SERVICE_2_QUEUE"
...
const PublishMessage = async (destination_service_binding_key, message) => {
  ...
  channel.publish(EXCHANGE_NAME, destination_service_binding_key, Buffer.from(message));
...
const SubscribeMessage = async () => {
  ...
  channel.bindQueue(CURRENT_SERVICE_SINGLE_QUEUE, EXCHANGE_NAME, CURRENT_SERVICE_SINGLE_BINDING_KEY);
